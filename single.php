                            ...
                            <div class="navigation post-navigation container">
                                <div class="row">
                                    <div class="nav-previous col-md-6 text-left">
                                        <a href="<?php echo esc_url(get_permalink($ignites_prev_post->ID));?>" class="nav-txt"> <?php esc_html_e('Previous post','ignites');?> </a>
		                                <?php
                                    ...
                                    <div class="nav-next col-md-6 text-right">
                                        <a href="<?php echo esc_url(get_permalink($ignites_next_post->ID));?>" class="nav-txt"> <?php esc_html_e('Next post','ignites');?> </a>
		                                <?php
